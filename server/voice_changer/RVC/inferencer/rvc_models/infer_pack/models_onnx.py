...
import voice_changer.RVC.inferencer.rvc_models.infer_pack.attentions_onnx as attentions
...
class SynthesizerTrnMsNSFsidM_nono(nn.Module):
    def __init__(
        self,
        spec_channels,
        segment_size,
        ...
        **kwargs
        ...
        super(SynthesizerTrnMsNSFsidM_nono, self).__init__()
        if isinstance(sr, str):
            sr = sr2sr[sr]
        self.spec_channels = spec_channels
        self.inter_channels = inter_channels
